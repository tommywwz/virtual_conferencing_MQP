        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                if len(self.tilt_buffer) >= hist:
                    # pop the first element of the buffer when buffer is longer than limit
                    del self.tilt_buffer[0]
                ...
                # calculate the ratio of head tilt to image rolling
                tilt_y_step = (y_center - halfFOV_w) / headbound_R
                # calculate the ratio of head tilt to image rolling
                tilt_x_step = (x_center - halfFOV_h) / headbound_U
